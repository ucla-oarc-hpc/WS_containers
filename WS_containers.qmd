...
- [Part II Next Wednesday on Building Container](https://idre.ucla.edu/calendar-event/building-containers-for-hpc)
:::
:::
...
<div style="display: flex; justify-content: center; align-items: center;">
  <img src="container_transfer.png" width="60%" />
</div>
...
<p align="center">
  <img src="matrix.gif" alt="Matrix GIF" width="120%">
</p>
...
## Virtual Machines: Hardware-Level Virtualization :desktop_computer:
...
- :mag: Look out for a follow-up workshop
  - [Container Building](https://idre.ucla.edu/calendar-event/building-containers-for-hpc)
