...
## Installing Software on Hoffman2
...
To fully grasp the concept of containers, it's essential to understand virtualization.

- Virtualization:
  - Enables multiple isolated systems to run on a single physical machine.
...
- 'Bare metal' refers to physical servers running directly on hardware without virtualization. :wrench:
  - Much like running software on your laptop
...
You can run MPI parallel software inside of containers. This example will compile and run a simple MPI code with a container.
